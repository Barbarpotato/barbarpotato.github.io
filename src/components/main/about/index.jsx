...
function About({ isLoading, aboutMe, width }) {
    ...
    return (
        <Suspense fallback={<Loading />}>
            {width >= 1280 ? <AboutDesktop isLoading={isLoading} aboutMe={aboutMe} contentStyle={contentStyle} avatarUrl={avatarUrl} resumeUrl={resumeUrl} /> :
                width >= 768 && width < 1280 ? <AboutTablet isLoading={isLoading} aboutMe={aboutMe} contentStyle={contentStyle} avatarUrl={avatarUrl} resumeUrl={resumeUrl} /> :
                    <AboutMobile isLoading={isLoading} aboutMe={aboutMe} contentStyle={contentStyle} avatarUrl={avatarUrl} resumeUrl={resumeUrl} />
            }
        </Suspense>
    )
}
